...
use Drupal\manage_inventory\InventoryInterface;
 ...
 *
 * @ContentEntityType(
 *   id = "content_entity_manage_inventory",
 *   label = @Translation("Inventory entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\manage_inventory\Entity\Controller\InventoryListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\manage_inventory\Form\InventoryForm",
 *       "edit" = "Drupal\manage_inventory\Form\InventoryForm",
 *       "delete" = "Drupal\manage_inventory\Form\InventoryDeleteForm",
 *     },
 *     "access" = "Drupal\manage_inventory\InventoryAccessControlHandler",
 *   },
 *   base_table = "inventory",
 *   admin_permission = "administer manage_inventory entity",
 *   fieldable = TRUE,
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 ...
 *   },
 *   links = {
 *     "canonical" = "/content_entity_manage_inventory/{content_entity_manage_inventory}",
 *     "edit-form" = "/content_entity_manage_inventory/{content_entity_manage_inventory}/edit",
 *     "delete-form" = "/inventory/{content_entity_manage_inventory}/delete",
 *     "collection" = "/content_entity_manage_inventory/list"
 *   },
 *   field_ui_base_route = "manage_inventory.inventory_settings",
 * )
 *
 ...
 *
 * Our interface (see InventoryInterface) also exposes the EntityOwnerInterface.
